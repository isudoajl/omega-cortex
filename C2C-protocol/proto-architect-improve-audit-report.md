...
[P4] PATCH SELF-AUDIT
  After generating all patches, before outputting:
    → For each patch, ask:
        ...
        2. Does this patch create a new priority conflict in Rule 8?
           If yes → include explicit Rule 8 amendment in the same batch
...
─────────────────────────────────────────────
  ...
  Phrase to activate: "IMPROVE: <protocol_name_and_version> AUDIT: <audit_report>"
